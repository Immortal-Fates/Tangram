...
void InitColor() {
	...
	DefineColor("#d4d8f0", 212.0 / 250.0, 216 / 250.0, 240 / 250.0);//浅蓝
	DefineColor("#232946", 35.0 / 250.0, 41.0 / 250.0, 70.0 / 250.0);//深蓝
	DefineColor("#eebbc3", 238.0 / 250.0, 187.0 / 250.0, 195.0 / 250.0);//浅粉
	DefineColor("#a786df", 167.0 / 250.0, 134.0 / 250.0, 233.0 / 250.0);//浅紫
	DefineColor("#3da9fc", 0.239, 0.663, 0.988);//亮蓝
	DefineColor("#ef4565", 239.0 / 250.0, 69.0 / 250.0, 101.0 / 250.0);//洋红
	DefineColor("#f9bc60", 249.0 / 250.0, 188.0 / 250.0, 96.0 / 250.0);//土黄
	DefineColor("#004643", 0 / 250.0, 70.0 / 250.0, 67.0 / 250.0);//暗绿
	DefineColor("#55423d", 85 / 250.0, 66.0 / 250.0, 61.0 / 250.0);//深棕色
	DefineColor("#ffc0ad", 250 / 250.0, 192 / 250.0, 173 / 250.0);//雅粉
	DefineColor("#9656a1", 150 / 255.0, 86 / 255.0, 161 / 250.0);//紫色
